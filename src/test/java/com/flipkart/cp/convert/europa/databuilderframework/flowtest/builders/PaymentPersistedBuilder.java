...
import com.flipkart.cp.convert.europa.databuilderframework.flowtest.data.PaymentPersistedData;
import com.flipkart.cp.convert.europa.databuilderframework.model.Data;

public class PaymentPersistedBuilder extends DataBuilder {
    @Override
    public Data process(DataBuilderContext context) throws DataBuilderException {
        return new PaymentPersistedData();
    }
}
