 ...
 * It uses {@link com.flipkart.cp.convert.europa.databuilderframework.model.Data} stored in the {@link com.flipkart.cp.convert.europa.databuilderframework.model.DataSet}.
 * All classes in the classpath derived from this class and annotated with
 * {@link com.flipkart.cp.convert.europa.databuilderframework.annotations.DataBuilderInfo}
...
public abstract class DataBuilder {
    ...
    /**
     * The metadata derived from the {@link com.flipkart.cp.convert.europa.databuilderframework.annotations.DataBuilderInfo}
     ...
     *
     * @param context The context object that contains the {@link com.flipkart.cp.convert.europa.databuilderframework.model.DataSet} available for this operation.
     * @return Returns the {@link com.flipkart.cp.convert.europa.databuilderframework.model.Data} to generated.
