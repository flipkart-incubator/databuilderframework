...
public class DataBuilderMetadataManager {
     ...
     * @param consumes List of {@link com.flipkart.cp.convert.europa.databuilderframework.model.Data} this builder consumes
     * @param produces {@link com.flipkart.cp.convert.europa.databuilderframework.model.Data} produced by this builder
    ...
    /**
     * Get {@link com.flipkart.cp.convert.europa.databuilderframework.model.DataBuilderMeta} meta for all builders that consume this data.
     * @param data Name of the data to be consumed
     * @return Set of {@link com.flipkart.cp.convert.europa.databuilderframework.model.DataBuilderMeta} for matching builders
    ...
    /**
     * Get {@link com.flipkart.cp.convert.europa.databuilderframework.model.DataBuilderMeta} for builder that produces this data
     * @param data Data being produced
     * @return List of {@link com.flipkart.cp.convert.europa.databuilderframework.model.DataBuilderMeta} that are capable of
    ...
    /**
     * Get {@link com.flipkart.cp.convert.europa.databuilderframework.model.DataBuilderMeta} for a particular builder.
