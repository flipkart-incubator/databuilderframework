...
/**
 * This class generates an {@link com.flipkart.cp.convert.europa.databuilderframework.model.ExecutionGraph}.
 * It uses the target data and resolution spec provided in the {@link com.flipkart.cp.convert.europa.databuilderframework.model.DataFlow}
...
public class DataFlowBuilder {
    ...
    /**
     * Generates an {@link com.flipkart.cp.convert.europa.databuilderframework.model.ExecutionGraph} for the given graph.
     ...
     * @param dataFlow The {@link com.flipkart.cp.convert.europa.databuilderframework.model.DataFlow} object to be analyzed
